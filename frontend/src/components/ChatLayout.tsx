...
export const ChatLayout: React.FC<ChatLayoutProps> = () => {
    ...
    // Auto-scroll only during streaming or when new messages arrive
    useEffect(() => {
        // Scroll to bottom when streaming starts/continues or when new messages are added
        if (isStreaming || streamingMessage) {
            messagesEndRef.current?.scrollIntoView({ behavior: 'smooth' });
        }
    }, [isStreaming, streamingMessage, activeSession?.messages?.length]);
